                        ...
                        <tr>
                            <td class="text-center">
                                @if($user->profile_photo)
                                    <img src="{{ asset('storage/' . $user->profile_photo) }}" alt="Imagen de {{ $user->name }}" class="rounded-circle" width="40" height="40">
                                @endif
                            </td>
                            <td>{{ $user->name }}</td>
                            ...
                            <td class="text-end text-nowrap">
                                ...
                                <button class="btn btn-danger btn-sm" onclick="deleteRecord('/admin/{{ $user->id }}/delete')">
